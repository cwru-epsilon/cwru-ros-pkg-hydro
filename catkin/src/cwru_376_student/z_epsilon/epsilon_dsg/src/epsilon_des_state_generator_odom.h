// epsilon_des_state_generator.h header file //
// aab; March, 2015
// include this file in "epsilon_des_state_generator.cpp"
...
#ifndef EPSILON_DES_STATE_GENERATOR_H_
#define EPSILON_DES_STATE_GENERATOR_H_
...
// dynamic limitations
const double MAX_SPEED = 1.1; // m/sec;
const double MAX_OMEGA = 1.8; //1.0; // rad/sec;
const double MAX_ACCEL = 0.9; // m/sec^2;
const double MAX_ALPHA = 1.5; // rad/sec^2;

const double LENGTH_TOL = 0.001; // tolerance for path; It was ADJUSTED to our needs for operation on GAZEBO
const double HEADING_TOL = 0.0001; // heading tolerance; It was ADJUSTED to our needs for operation on GAZEBO
...
public:
    ...
    geometry_msgs::Pose map_to_odom_pose(geometry_msgs::Pose map_pose);
