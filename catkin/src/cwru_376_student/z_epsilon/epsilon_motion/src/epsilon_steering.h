// epsilon_steering_algorithm.h header file //
// aab119; Mar, 2015
// include this file in "epsilon_steering_algorithm.cpp"

#ifndef EPSILON_STEERING_ALGORITHM_H_
#define EPSILON_STEERING_ALGORITHM_H_
...
public:
    ...
    bool epsilon_steering_algorithm(); // here is the heart of it...use odom state and desired state to compute twist command, and publish it
